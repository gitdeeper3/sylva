...
# رفع الملفات
print("🚀 رفع sylva-fire v2.5.5 مع الوصف الكامل...")

files = [
    ("dist/sylva_fire-2.5.5-py3-none-any.whl", "bdist_wheel"),
    ("dist/sylva_fire-2.5.5.tar.gz", "sdist")
]
...
if success:
    print("🎉 تم رفع v2.5.5 بنجاح!")
    print("⏳ انتظر 3-5 دقائق، ثم تحقق:")
    print("   https://pypi.org/project/sylva-fire/2.5.5/")
else:
